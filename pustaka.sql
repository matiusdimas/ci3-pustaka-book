...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2023 at 09:16 AM
...
(2, 'Statiskia', 1, 'Ahmad', 'Deep Publish', '2014', '12312152', 7, 1, 2, 'asd.jpg');
...
INSERT INTO `user` (`user`, `nama`, `email`, `image`, `password`, `role_id`, `is_active`, `tanggal_input`) VALUES
(1, 'asd', 'asd@gmail.com', 'asd.jpg', 'asd', 1, 1, 115500);
...
--
ALTER TABLE `buku`
  ADD CONSTRAINT `buku_ibfk_1` FOREIGN KEY (`id_kategori`) REFERENCES `kategori` (`id_kategori`) ON DELETE CASCADE ON UPDATE NO ACTION;
